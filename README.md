...
[![Cyphon](docs/source/_static/images/cyphon-logo.png)](https://cyphon.io)
...
![Cyphon admin dashboard](docs/source/_static/images/screenshots/cyphon-admin.png)
...
![Cyclops UI dashboard view](docs/source/_static/images/screenshots/cyclops-dashboard.png)
...
![Cyclops UI alert view](docs/source/_static/images/screenshots/cyclops-alerts.png)

![Cyclops UI related data panel](docs/source/_static/images/screenshots/related-data.png)
...
* [Logstash](https://www.elastic.co/logstash) data ingestion tool
